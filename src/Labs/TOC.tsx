...
export default function TOC() {
  ...
  return (
    <Nav variant="pills">
      ...
      <Nav.Item>
        <Nav.Link as={Link} to="/Labs/Lab5" active={pathname.includes("Lab5")}>      Lab 5
        </Nav.Link>
      </Nav.Item>
      <Nav.Item>
      ...
      <Nav.Item>
        <Nav.Link
          href="https://kambaz-node-server-app-71ob.onrender.com"
          target="_blank"
        >
          Render
        </Nav.Link>
      ...
      <Nav.Item>
        <Nav.Link
          href="https://github.com/WSantry/kambaz-node-server-app.git"
          target="_blank"
        >
          Github:Node
        </Nav.Link>
